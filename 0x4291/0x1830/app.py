...
OPTIONS = [VERTICAL, HORIZONTAL, COASTAL, DIAGONAL_NW_SE, DIAGONAL_NE_SW]
...
class UKMap(app.App):
	def __init__(self, config=None):
		...
		self.inner_leds = neopixel.NeoPixel(config.pin[3], 78)
		self.alignment = 0
		self.leds = neopixel.MergedNeoPixels(self.inner_leds, OPTIONS[self.alignment])
		self.brightness = 0.1
		self.running = True
